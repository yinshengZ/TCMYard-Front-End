        ...
        <el-card shadow="hover">
          ...
          <div class="card-body">
            ...
            <div>
              <span>
                Income: £
                <count-to :start-val="0" :end-val="Number(highest_daily.amount)" :duration="2600" />
              </span>
        ...
        <el-card shadow="hover">
          ...
          <div class="card-body">
            ...
            <div>
              <span>
                Income: £
                <count-to :start-val="0" :end-val="Number(highest_weekly.amount)" :duration="2600" />
              </span>
        ...
        <el-card shadow="hover">
          ...
          <div class="card-body">
            ...
            <div>
              <span>
                Income: £
                <count-to :start-val="0" :end-val="Number(highest_monthly.amount)" :duration="2600" />
              </span>
        ...
        <el-card shadow="hover">
          ...
          <div class="card-body">
            ...
            <div>
              <span>
                Income: £
                <count-to :start-val="0" :end-val="Number(highest_yearly.amount)" :duration="2600" />
              </span>
