      ...
      <div class="add-item-form">
        <el-form ref="add-item-form" :model="inventory_details" label-width="120px">
          <el-form-item label="Chinese Name">
            <el-input v-model="inventory_details.name" />
          </el-form-item>

          <el-form-item label="English Name">
            <el-input v-model="inventory_details.eng_name" />
          </el-form-item>

          <el-form-item
            label="Unit Price"
          >
            <el-input-number v-model="inventory_details.unit_price" :precison="2" :step="0.1" :min="0" :max="999999" />
          </el-form-item>
          ...
          <el-form-item label="Description">
            <el-input v-model="inventory_details.description" type="textarea" />
          </el-form-item>
  ...
  methods: {
    ...
    get_categories() {
      getAll().then((response) => {
        this.categories_rtv = response.data
      })
