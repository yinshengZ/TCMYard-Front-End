<template>
  <div class="app-container">
    <el-row :gutter="20">
      <el-col :span="6" :xs="24">
        <patient-card :patient_id="patient_id" />
      </el-col>
        ...
        <el-card>
          <el-tabs v-model="activeTab" @tab-click="handleClick">
            <el-tab-pane lazy label="Records" name="records">
              <records-card :key="key" :patient_id="patient_id" :user_id="user.id" :user_name="user.name" />
            </el-tab-pane>
            ...
            <el-tab-pane lazy label="Finance" name="finance">
              <finance-card :key="key" :patient_id="patient_id" :user_id="user.id" />
            </el-tab-pane>
