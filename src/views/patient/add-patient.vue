<template>
  <div class="app-container">
    <el-card class="box-card" shadow="hover">
      <el-form id="add_patient" ref="patient-info" :model="patient_info" label-width="140px" label-position="left">
        <el-row :gutter="20">
          <el-col :span="11">
        ...
        <el-form-item label="Medications" prop="current_medication">
          ...
          <el-tooltip content="Add New Medications" placement="top">
            <el-button class="add-button" @click="load_medication"><svg-icon icon-class="add" /></el-button>
        ...
        <el-form-item label="Diseases">
          ...
          <el-tooltip content="Add New Diseases" placement="top">
            <el-button class="add-button" @click="load_disease"><svg-icon icon-class="add" /></el-button>
          </el-tooltip>
