          ...
          <div class="search-buttons">
            <el-form-item label="">
              <el-tooltip effect="dark" content="Search Patient" placement="top">
                <el-button class="search-button" type="primary" icon="el-icon-search" @click="search_patient" />
              </el-tooltip>

              <el-tooltip effect="dark" content="Reset" placement="top">
                <el-button class="search-button" type="default" icon="el-icon-refresh" @click="reset_input" />

              </el-tooltip>
              <el-tooltip effect="dark" content="Add Patient" placement="top">
                <el-button class="search-button" type="success" icon="el-icon-plus" @click="add_new_patient" />
              </el-tooltip>
            </el-form-item>
          </div>
        </div>
