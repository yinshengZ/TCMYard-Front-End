        ...
        <el-table-column prop="operations" label="Operations">
          <template slot-scope="{ row }">
            ...
            <el-popconfirm
              ...
              @onConfirm="delete_treatment(row.id)"
              @onCancel="get_patient_treatments()"
            >
              <el-button slot="reference" style="margin-left:5%" type="danger">Delete</el-button>
            </el-popconfirm>
