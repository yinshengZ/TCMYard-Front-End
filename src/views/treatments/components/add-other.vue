<template>
  <div>
    <el-button style="width:100%; margin-bottom:3%;" type="success" icon="el-icon-plus" @click="add_item_row">Item</el-button>
    <div v-if="others_details.length >0" class="add-other-treatment-form">
  ...
  methods: {
    ...
    get_all_others_inventory() {
      get_others().then((response) => {
        this.others_inventory = response.data
      })
    },
