      ...
      <el-form v-model="retail_details" label-width="120px" label-position="left">
        ...
        <div v-if="with_finance">
          ...
          <el-form-item label="Price (£): ">
            ...
            <el-button style="margin-left:10px" type="primary" @click="calculate_price">Calculate</el-button>
          </el-form-item>
          <el-form-item v-model="original_amount" label="Normal Price(£):" label-width="120px">
  ...
  methods: {
    ...
    get_all_retails() {
      get_retails().then((response) => {
        this.all_retails = response.data
      })
    },
