  ...
  <div>
    <div class="operation-buttons">
      <div class="add-button">
        <el-button type="success" icon="el-icon-plus" class="add-herbs-button" @click="add_item_row">Herb</el-button>
      </div>
    ...
    <el-form v-model="treatment_detail" label-width="120px">
        ...
        <el-form-item :label="'Item ' + (index + 1)">
          <div class="grid-container">
            ...
            <div class="herb-units">
              <el-input-number v-model="inventory.pivot.units" size="mini" />
      ...
      <el-form-item label="Quantity">
        <el-input-number v-model="treatment_detail.quantity" :min="1" :max="99999" :step="1" />
      </el-form-item>
      ...
      <div v-if="with_finance">
        ...
        <el-form-item label="Price">
          ...
          <el-input-number
            v-model="treatment_detail.incomes[0].amount"
            :min="0"
            :max="999999999"
            :precision="2"
          />
    ...
    calculate_herb_price() {
      ...
      if (this.treatment_detail.inventories.length > 0) {
        for (let i = 0; i < this.treatment_detail.inventories.length; i++) {
          const result = this.all_inventories.find(item => item.id === this.treatment_detail.inventories[i].id)
